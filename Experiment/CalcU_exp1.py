...
Rs = np.loadtxt('thetaUnwrapStuck1.txt')
phaseR=np.loadtxt('thetaStuck1.txt')+pi
plt.plot(phaseR)

#%%
#%
SizeFactor = 1
nums=32500 # Simulation steps
dt = 1/219; # Delta t of the simulation (Could be variable)
